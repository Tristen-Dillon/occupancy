    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        <input
          ...
          type="file"
          accept=".json"
          onChange={(e) => handleFileChange(Array.from(e.currentTarget.files || []))}
          className="hidden"
        />
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div
            className={cn(
              'relative w-full mt-6 max-w-xl mx-auto cursor-pointer',
              ...
              files.map((file, idx) => (
                ...
                >
                  ...
                  <div className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-neutral-600 dark:text-neutral-400">
                    ...
                    <Button variant="outline" onClick={() => handleRemoveFile(file)}>
                      Remove
                    </Button>
                  </div>
                </motion.div>
