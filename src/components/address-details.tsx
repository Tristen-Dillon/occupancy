        ...
        <CardContent className="grid gap-4 w-full">
          ...
          <div>
            ...
            <div className="grid gap-2">
              {validated.result.address.addressComponents.map((component, index) => (
          ...
          <div>
            ...
            <div className="grid gap-2">
              <div className="flex items-center gap-2">
                <Badge
                  variant={validated.result.verdict.addressComplete ? 'secondary' : 'destructive'}
                >
                  {validated.result.verdict.addressComplete ? 'Complete' : 'Incomplete'}
                </Badge>
              ...
              <div className="flex items-center gap-2">
                <Badge
                  variant={
                    validated.result.verdict.hasUnconfirmedComponents ? 'secondary' : 'default'
                  }
                >
                  {validated.result.verdict.hasUnconfirmedComponents ? 'Unconfirmed' : 'Confirmed'}
                </Badge>
          ...
          <div>
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="outline">{validated.result.uspsData.carrierRoute}</Badge>
