...
export interface Config {
  ...
  collectionsSelect: {
    ...
    occupancy: OccupancySelect<false> | OccupancySelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "occupancy_select".
 */
export interface OccupancySelect<T extends boolean = true> {
  name?: T;
  address?: T;
  location?:
    | T
